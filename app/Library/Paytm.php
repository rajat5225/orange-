...
class Paytm {
	...
	public function getConfig() {
		$settings = BusRuleRef::whereIn('rule_name', ['paytm_staging_mid', 'paytm_merchant_key', 'paytm_industry_type', 'paytm_channel_id', 'paytm_app_name', 'paytm_callback_url', 'paytm_transaction_url'])->pluck('rule_value', 'rule_name');
		return $settings;
	}
