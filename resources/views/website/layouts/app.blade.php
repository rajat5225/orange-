<?php
$social = App\Model\BusRuleRef::select("rule_name", "rule_value")->whereIn("rule_name", array("twitter_social_link", "facebook_social_link", "linkedin_social_link", "instagram_social_link"))->get();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{URL::asset('/css/website_style.css')}}" />
        <link rel="stylesheet" href="{{URL::asset('/css/owl.css')}}" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" />
        <style type="text/css">
            .driverImage, .driverDoc{
                display: none;
            }
            .docUpload{
                float: left;
