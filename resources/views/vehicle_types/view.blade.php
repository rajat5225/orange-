@extends('layouts.app')
@section('title', 'Vehicle - ' . $vehicle->vehicle_type)

@section('content')
	<div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Vehicle - {{$vehicle->vehicle_type}} <a href="{{route('editVehicle', ['id'=>$vehicle->id])}}" class="toolTip" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil"></i></a></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{route('vehicles')}}">Vehicles</a></li>
                    <li class="breadcrumb-item active">Vehicle - {{$vehicle->vehicle_type}}</li>
                </ol>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center class="m-t-30"> <img src="@if($vehicle->image != null && file_exists(public_path('/uploads/vehicles/'.$vehicle->image))){{URL::asset('/uploads/vehicles/'.$vehicle->image)}} @else {{URL::asset('/images/user-gray.png')}} @endif" class="img-circle" width="150" />
                            <h4 class="card-title m-t-10">{{$vehicle->vehicle_type}}</h4>
                        </center>
                    </div>
                    <div>
                        <hr> </div>
