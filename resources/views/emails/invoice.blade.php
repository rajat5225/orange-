...
<table cellspacing="0" style="margin: -8px auto 0; width: 700px; font-family: 'Roboto', sans-serif;">
    ...
    <tr style="margin: 30px 0;display: block;padding: 0 25px;">
        <td>
            <p style="font-size: 30px;font-weight: bold;margin-bottom: 0px;">₹ {{$data->total}}</p>
            <p style="color: #5f5e5e;">Thanks for choosing NXG Charge, {{$data->name}}</p>
            <p style="color: #5f5e5e;">{{date("M d, Y",strtotime($data->created_at))}} | NXG Charge</p>
        </td>
    </tr>
    ...
    <tr style="margin: 0;">
        <td>
            <div style="text-align: center;margin-top: 50px;">
                <img src="{{$data->driver_profile_picture}}" width="100" alt="">
            </div>
            <div style="text-align: center;">
                <p>You rode with {{$data->driver_name}}</p>
            </div>
            ...
            <div style="text-align: center;margin-top: 50px;">
                @php
                // print_r($data);
                $rating = URL::asset("/images/rating/img".$data->driver_rating.".png");
                @endphp
                <img src="{{URL::asset($rating)}}" alt="">
            </div>
        </td>
    </tr>
                ...
                <tr style="background-color: #e8e8e8;">
                    <td style="padding: 10px 25px;border-top: 1px solid #ccc;">
                        ...
                        <div style="display: inline-block;width: 100%;">
                            ...
                            <p style="float: right;width: 50%;text-align: right; font-size: 14px;color: #5f5e5e;">₹ {{$data->total_without_tax}}</p>
                        </div>
                    </td>
                </tr>
                ...
                <tr style="background-color: #e8e8e8;">
                    <td style="padding: 10px 25px;display: block;border-top: 1px solid #ccc;">
                        ...
                        <!-- <div style="display: inline-block;width: 100%;">
                            ...
                            <p style="float: right;width: 50%;text-align: right; font-size: 14px;color: #5f5e5e;">&#x20B9 {{-- {{$data->wait_charge}} --}}</p>
                        </div> -->
                    </td>
                </tr>
                ...
                <tr style="background-color: #e8e8e8;">
                    <td style="padding: 10px 25px;display: block;border-top: 1px solid #ccc;">
                        ...
                        <div style="display: inline-block;width: 100%;">
                            ...
                            <p style="float: right;width: 50%;text-align: right; font-size: 14px;color: #5f5e5e;">₹ {{$data->cgst}}</p>
                        </div>
                        <div style="display: inline-block;width: 100%;">
                            <p style="float: left;width: 50%; font-size: 14px;color: #5f5e5e;">SGST/UTGST ({{$data->sgst_percent}}%) </p>
                            <p style="float: right;width: 50%;text-align: right; font-size: 14px;color: #5f5e5e;">₹ {{$data->sgst}}</p>
                        </div>
                    </td>
                </tr>
                ...
                <tr style="background-color: #e8e8e8;">
                    <td style="padding: 10px 25px;display: block;border-top: 1px solid #ccc;">
                        ...
                        <div style="display: inline-block;width: 100%;">
                            ...
                            <p style="margin-top:0px;float: right;width: 50%;text-align: right;font-size: 30px;font-weight: bold;color: #262626;">₹ {{$data->total}}</p>
                        </div>
                    </td>
                </tr>
