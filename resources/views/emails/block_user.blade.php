    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <p style="font-weight: bold; font-size: 18px; margin-top: 60px;">Hi {{ucfirst($mailData['name'])}},</p>
                        <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">Your are blocked from NXG Charge App.</p>
                        @if($blockReason['reason']!="")
                            <div style="height: 300px;">
                                <p style="font-weight: bold; font-size: 18px; margin-top: 60px;">Reason</p>
                                <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">{{ucfirst($blockReason['reason'])}}</p>
                            </div>
                        @endif
                    </td>
                </tr>
